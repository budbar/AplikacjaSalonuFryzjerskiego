...
function Account() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-primary rounded-lg shadow-md text-secondary">
      <h1 className="text-2xl font-bold mb-4 underline-border">Konto użytkownika</h1>
          ...
          <form onSubmit={handleUpdateOfAddressData}>
            <div className="mb-4">
              ...
              <input
                type="text"
                name="residence"
                className="w-full px-3 py-2 bg-input rounded"
                value={residence}
            ...
            <button type="submit" className="w-full bg-button hover-bg-button text-white py-2 rounded font-bold">Zaktualizuj dane adresowe</button>
          </form>
        </div>
      </div>
    </div>
